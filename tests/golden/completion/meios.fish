...
complete -c meios -n '__fish_seen_subcommand_from deps' -l eval -r -d 'Expression evaluator backend: core or python.'
complete -c meios -n '__fish_seen_subcommand_from deps' -l eval-policy -r -d 'Policy for an unsupported expression: fail, warn, or skip.'
