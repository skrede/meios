...
public:
    ...
    explicit source_handle(S s) : m_self(std::make_unique<model<S>>(std::move(s))) {}
...
private:
    ...
    struct model final : concept_t
    {
        ...
        std::optional<std::filesystem::path> do_path(std::string_view pkg,
                                                     std::string_view rel) const override
        {
